...
void blurImage(){
    ...
    switch (blurLevel) {
        case 1:
            for (int i = 0; i < SIZE ; i++){
                for(int j = 0; j < SIZE ; j++){
                    int blur = blurAlgorithm(refrenceImage,i,j,5);
                    image[i][j]=blur;
                }
            }
            break;
        case 2:
            for (int i = 0; i < SIZE ; i++){
                for(int j = 0; j < SIZE ; j++){
                    int blur = blurAlgorithm(refrenceImage,i,j,7);
                    image[i][j]=blur;
                }
            }
            break;
        case 3:
            for (int i = 0; i < SIZE ; i++){
                for(int j = 0; j < SIZE ; j++){
                    int blur = blurAlgorithm(refrenceImage,i,j,9);
                    image[i][j]=blur;
                }
            }
            break;
